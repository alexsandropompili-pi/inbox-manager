...
const DEMO_MESSAGES: Message[] = [
  // ── Arrivato ──
  {
    ...
    token_code: '2026-COM-001',
    notion_1: 'Richiesta preventivo enterprise',
    notion_2: 'Alta priorità - decisione d\'acquisto imminente',
    notion_3: 'TechCorp - 50 utenti',
  ...
  },
  {
    ...
    token_code: '2026-SUP-001',
    notion_1: 'Interruzione servizio - errore 503',
    notion_2: 'Urgente - blocca produzione',
    notion_3: 'StartupXYZ - integrazione API',
  ...
  },
  {
    ...
    channel: 'email',
    assigned_to: null,
    token_code: '2026-GEN-001',
    notion_1: 'Feedback UX su modulo reportistica',
    notion_2: 'Bassa priorità - suggerimenti migliorativi',
    notion_3: 'Cliente Luca Rossi',
  ...
  },
  {
    ...
    channel: 'email',
    assigned_to: null,
    token_code: '2026-AMM-001',
    notion_1: 'Rinnovo contratto annuale',
    notion_2: 'Bassa priorità - documentazione inviata',
    notion_3: 'Partner Anna Bianchi',
  ...
  // ── In svolgimento ──
  {
    ...
    token_code: '2026-COM-002',
    notion_1: 'Conferma demo con CTO',
    notion_2: 'Media priorità - venerdì 18',
    notion_3: 'BigClient - Pietro Verdi',
  ...
  },
  {
    ...
    channel: 'whatsapp',
    assigned_to: null,
    token_code: '2026-COM-003',
    notion_1: 'Domanda limiti piano Pro',
    notion_2: 'Bassa priorità - valutazione acquisto',
    notion_3: 'Studio Elena Marino - team 12 persone',
  ...
  },
  {
    ...
    channel: 'email',
    assigned_to: 'sofia.b@team.dev',
    token_code: '2026-AMM-002',
    notion_1: 'Revisione report Q1 2026',
    notion_2: 'Alta priorità - presentazione board',
    notion_3: 'Holding Giacomo Conti - sezione conversioni',
  ...
  // ── Concluso ──
  {
    ...
    channel: 'email',
    assigned_to: 'marco.r@team.dev',
    token_code: '2026-GEN-002',
    notion_1: 'Completamento onboarding account',
    notion_2: 'Informativo - nessuna azione richiesta',
    notion_3: 'Platform - customer success assegnato',
  ...
  },
  {
    ...
    channel: 'email',
    assigned_to: null,
    token_code: '2026-FAT-001',
    notion_1: 'Conferma rinnovo abbonamento annuale',
    notion_2: 'Informativo - pagamento elaborato',
    notion_3: 'Platform - fattura disponibile in area cliente',
